  ...
  <div class="max-w-7xl mx-auto px-4 py-6">
    ...
    <div class="mt-4">
      @if($product->image_path)
        <img src="{{ Storage::url($product->image_path) }}" alt="{{ e($product->name) }}" class="w-64 h-64 object-cover border">
      @else
        <div class="w-64 h-64 bg-gray-200 flex items-center justify-center border">
